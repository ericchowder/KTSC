...
$query = "SELECT ktcs_members.member_no,ktcs_members.first_name,ktcs_members.last_name, reservations.reservation_no FROM ktcs_members NATURAL JOIN reservations WHERE reservations.member_no=23333334;";
$result = mysqli_query($con, $query);
//Finding Start Date
$sDateQuery = "SELECT reservations.date FROM reservations NATURAL JOIN ktcs_members
	WHERE reservations.member_no=23333334;";
